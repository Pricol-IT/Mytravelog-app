            ...
            case "Flight":
                for (var i = 0; i < fl_class.length; i++) {
                    if (
                        ...
                        $(".rq").show();
                        $("#Flightbody").append(
                            '<tr><td><input type="hidden" name="flightfrom[]" value="' +
                                from[i] +
                                '" >' +
                                from[i] +
                                '</td><td><input type="hidden" name="flightto[]" value="' +
                                to[i] +
                                '" >' +
                                to[i] +
                                '</td><td><input type="hidden" name="flightdate[]" value="' +
                                sdate[i] +
                                '" >' +
                                date[i] +
                                "/" +
                                time[i] +
                                '</td><td><input type="hidden" name="flightclass[]" value="' +
                                fl_class[i] +
                                '" >' +
                                fl_class[i] +
                                ...
                                preferences +
                                '</p> <input name="preferences[]" type="hidden" value="' +
                                preferences +
                                '"></td></tr>'
                        );
            ...
            case "Train":
                for (var i = 0; i < tr_class.length; i++) {
                    if (
                        ...
                        $(".rt").show();
                        $("#Trainbody").append(
                            '<tr><td><input type="hidden" name="trainfrom[]" value="' +
                                from[i] +
                                '" >' +
                                from[i] +
                                '</td><td><input type="hidden" name="trainto[]" value="' +
                                to[i] +
                                '" >' +
                                to[i] +
                                '</td><td><input type="hidden" name="traindate[]" value="' +
                                sdate[i] +
                                '" >' +
                                date[i] +
                                "/" +
                                time[i] +
                                '</td><td><input type="hidden" name="trainclass[]" value="' +
                                tr_class[i] +
                                '" >' +
                                tr_class[i] +
            ...
            case "Bus":
                for (var i = 0; i < bs_class.length; i++) {
                    if (
                        ...
                        $(".rb").show();
                        $("#Busbody").append(
                            '<tr><td><input type="hidden" name="busfrom[]" value="' +
                                from[i] +
                                '" >' +
                                from[i] +
                                '</td><td><input type="hidden" name="busto[]" value="' +
                                to[i] +
                                '" >' +
                                to[i] +
                                '</td><td><input type="hidden" name="busdate[]" value="' +
                                sdate[i] +
                                '" >' +
                                date[i] +
                                "/" +
                                time[i] +
                                '</td><td><input type="hidden" name="busclass[]" value="' +
                                bs_class[i] +
                                '" >' +
                                bs_class[i] +
                                '</td><td><button class="btn btn-danger remove"><i class="bx bx-trash"></i></button></td></tr><tr><td colspan="5 "><p class="text-primary" style="font-size:12px;margin:0;">' +
    ...
    if (extra_service != "") {
        switch (extra_service) {
            case "Taxi":
                ...
                if (carRental != "yes") {
                    $("#Taxibody").append(
                        '<tr><td><input type="hidden" name="taxiRequest[]" value="' +
                            extra_service +
                            '" ><input type="hidden" name="airportToHotel[]" value="' +
                            airportToHotel +
                            '" >' +
                            airportToHotel +
                            '</td><td><input type="hidden" name="hotelToCompany[]" value="' +
                            hotelToCompany +
                            '" >' +
                            hotelToCompany +
                            '</td><td> <input type="hidden" name="noOfDays[]" value="' +
                            noOfDays +
                            '" >' +
                            "-" +
                            '</td><td> <input type="hidden" name="tx_class[]" value="' +
                            tx_class +
                            '" >' +
                            "-" +
                            '</td><td><input type="hidden" name="pickupDate[]" value="' +
                            pickupDate +
                            '" >' +
                            "-" +
                            '</td><td> <input type="hidden" name="dropDate[]" value="' +
                            dropDate +
                            '" >' +
                            "-" +
                ...
                if (location != "" && checkIn != "" && checkOut != "") {
                    ...
                    $("#Hotelbody").append(
                        '<tr><td><input type="hidden" name="location[]" value="' +
                            ...
                            '" >' +
                            hotelName +
                            '</td><td><input type="hidden" name="checkin[]" value="' +
                            checkIn +
                            '" >' +
                            checkIndate +
                            " / " +
                            checkIntime +
                            '</td><td><input type="hidden" name="checkout[]" value="' +
                            checkOut +
                            '" >' +
                            checkOutdate +
                            " / " +
            ...
            case "Advance":
                if (amount != "") {
                    ...
                    if (specialApproval != "no") {
                        $("#Advancebody").append(
                            '<tr><td><input type="hidden" name="specialApproval[]" value="' +
                                specialApproval +
                                '" ><input type="hidden" name="amount[]" value="' +
                                amount +
                                '" >' +
                                amount +
                                '</td><td><input type="hidden" name="splAdvance[]" value="' +
                                splAdvance +
                                '" >' +
                                splAdvance +
                                '</td><td><button class="btn btn-danger remove"><i class="bx bx-trash"></i></button></td></tr>'
            ...
            case "Forex":
                if (currency != "" && forex_amount != "") {
                    $(".rf").show();
                    $("#Forexbody").append(
                        '<tr><td><input type="hidden" name="currency[]" value="' +
                            currency +
                            '" >' +
                            currency +
                            '</td><td><input type="hidden" name="forex_amount[]" value="' +
                            forex_amount +
                            '" >' +
                            forex_amount +
                            '</td><td><button class="btn btn-danger remove"><i class="bx bx-trash"></i></button></td></tr>'
