            ...
            <div class="modal-body">
                <form id='service-form' action="#">
                    ...
                    <div class=" row">
                        ...
                        <div class="col-6">
                            <label>From</label>
                            <input type="text" required class="form-control" name="from" id="from"
                                placeholder="Origin">
                        </div>
                        <div class="col-6">
                            <label>To</label>
                            <input type="text" required class="form-control" name="to" id="to"
                        ...
                        <div class="col-6 flight-form">
                            <div class="form-check">
                                ...
                                <label class="form-check-label" for="flexCheckDefault" data-toggle="tooltip"
                ...
                <select class="form-control" required name="tx_class" id="tx_class">
                  ...
                  <option value="SUV">SUV</option>
                    ...
                    <br>
                    <center>
                        <button type="button" class="btn btn-secondary closeService"
