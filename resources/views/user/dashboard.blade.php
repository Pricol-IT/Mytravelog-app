            ...
            <div class="row">
              ...
              <div class="col-lg-6">
                <div class="d-flex">
                  ...
                  <input class="form-check-input" type="radio" name="tripType" id="domestic" value="domestic" required>
                  <label class="form-check-label" for="domestic">
                    Domestic
                  </label>
                  </div>
                  <div class="form-check m-2">
                  <input class="form-check-input" type="radio" name="tripType" id="international"  value="international" required>
