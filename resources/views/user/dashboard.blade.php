            ...
            <div class="row">
                ...
                <div class="col-lg-6">
                    ...
                    <div class="d-flex">
                        ...
                        <div class="form-check m-2">
                            <input class="form-check-input" type="radio" name="trip_type" id="international" value="international" required>
            ...
            <section class="section dashboard">
                <div class="row ">
                    <div class="  col-lg-6  col-md-6 ">
                        <div class="urbox-card urbox rounded  shadow text-white mb-3 ">
                            <div class="heading d-flex justify-content-between align-items-center mb-3">
                                ...
                                <a href="#" class="text-decoration-none text-white" style="cursor: pointer;">View
                                    More >>></a>
                            </div>
                            ...
                            <div class="heading d-flex justify-content-between ">
                                <p>Hotel </p>
                                <div class="status d-flex">
                                    <div class="shadow indicator m-2" style="background-color: orange !important;">
                                    </div>
                            ...
                            <!-- <h5 class="text-center">Coming Soon</h5> d-flex align-items-center justify-content-center -->
                        </div>
                    ...
                    <div class="col-lg-6 col-md-6">
                        <div class="urbox p-3 mb-3 rounded bg-theme shadow">
                            <!-- Default Tabs -->
                            <ul class="nav nav-tabs d-flex bg-theme divch" id="myTabjustified" role="tablist">
                                <li class="nav-item flex-fill" role="presentation">
                                    <button class="nav-link w-100 active" id="Upcoming-tab" data-bs-toggle="tab" data-bs-target="#Upcoming-justified" type="button" role="tab" aria-controls="Upcoming" aria-selected="true">Upcoming</button>
                                </li>
                                <li class="nav-item flex-fill" role="presentation">
                                    <button class="nav-link w-100" id="Recent-tab" data-bs-toggle="tab" data-bs-target="#Recent-justified" type="button" role="tab" aria-controls="Recent" aria-selected="false">Recent</button>
                                </li>
                            </ul>
                            <div class="tab-content pt-2" id="myTabjustifiedContent">
                                <div class="tab-pane fade show active" id="Upcoming-justified" role="tabpanel" aria-labelledby="Upcoming-tab">
                                    @forelse ($upcomingtrips as $trip)
                                    <div class="tripcard p-2 rounded shadow mt-1" style="background-color: #fff; color:#0072BC">
                                        <div class=" d-flex justify-content-between">
                                            <p><b>Trip id :</b> {{ $trip->tripid }} </p>
                                            <p><b>Date :</b> {{ $trip->from_date }}</p>
                                        </div>
                                        <div class=" d-flex justify-content-between">
                                            <h5>{{ $trip->tripname }}</h5>
                                            <p><b>To :</b> {{ $trip->to_date }}</p>
                                ...
                                <div class="tab-pane fade" id="Recent-justified" role="tabpanel" aria-labelledby="Recent-tab">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 col-md-6 ">
                        ...
                        {{-- <h5 class="text-center">Calendar <br> Coming Soon </h5> bg-white d-flex align-items-center justify-content-center shadow rounded --}}
