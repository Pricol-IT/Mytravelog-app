...
<main id="main" class="main">
    <div class="content">
        <div class="container-fluid">
            ...
            <form action="{{route('domestic_policy.store')}}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="card">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4 mt-2">
                                            <div class="form-group">
                                                ...
                                                <span class="form-label-required text-danger">*</span>
                                                <input type="text" name="junior_tier1" id="junior_tier1" class="form-control class " value="{{old('junior_tier1')}}" placeholder="eg: Bus,Train">
                                        ...
                                        <div class="col-md-4 mt-2">
                                            <div class="form-group">
                                                ...
                                                <span class="form-label-required text-danger">*</span>
                                                <input type="text" name="junior_tier2" id="junior_tier2" class="form-control class " value="{{old('junior_tier2')}}" placeholder="eg: Bus,Train">
                                        ...
                                        <div class="col-md-4 mt-2">
                                            <div class="form-group">
                                                ...
                                                <span class="form-label-required text-danger">*</span>
                                                <input type="text" name="junior_tier3" id="junior_tier3" class="form-control class " value="{{old('junior_tier3')}}" placeholder="eg: Bus,Train">
                                        ...
                                        <div class="col-md-4 mt-2">
                                            <div class="form-group">
                                                ...
                                                <span class="form-label-required text-danger">*</span>
                                                <input type="text" name="middle_tier1" id="middle_tier1" class="form-control class " value="{{old('middle_tier1')}}" placeholder="eg: Bus,Train">
                                        ...
                                        <div class="col-md-4 mt-2">
                                            <div class="form-group">
                                                ...
                                                <span class="form-label-required text-danger">*</span>
                                                <input type="text" name="middle_tier2" id="middle_tier2" class="form-control class " value="{{old('middle_tier2')}}" placeholder="eg: Bus,Train">
                                        ...
                                        <div class="col-md-4 mt-2">
                                            <div class="form-group">
                                                ...
                                                <span class="form-label-required text-danger">*</span>
                                                <input type="text" name="middle_tier3" id="middle_tier3" class="form-control class " value="{{old('middle_tier3')}}" placeholder="eg: Bus,Train">
                                        ...
                                        <div class="col-md-4 mt-2">
                                            <div class="form-group">
                                                ...
                                                <span class="form-label-required text-danger">*</span>
                                                <input type="text" name="senior_tier1" id="senior_tier1" class="form-control class " value="{{old('senior_tier1')}}" placeholder="eg: Bus,Train">
                                        ...
                                        <div class="col-md-4 mt-2">
                                            <div class="form-group">
                                                ...
                                                <span class="form-label-required text-danger">*</span>
                                                <input type="text" name="senior_tier2" id="senior_tier2" class="form-control class " value="{{old('senior_tier2')}}" placeholder="eg: Bus,Train">
                                        ...
                                        <div class="col-md-4 mt-2">
                                            <div class="form-group">
                                                ...
                                                <span class="form-label-required text-danger">*</span>
                                                <input type="text" name="senior_tier3" id="senior_tier3" class="form-control class " value="{{old('senior_tier3')}}" placeholder="eg: Bus,Train">
